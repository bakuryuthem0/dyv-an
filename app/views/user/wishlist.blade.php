...
<div class="hidden-container container-in">
  ...
  <div class="contenido">
	...
	@endif
	<div class="col-xs-12">
		<p class="textoPromedio">A continuación se mostrara su lista de deseos, si desea podra agregar el item a su carrito si se dispone de stock</p>
		<table class="table table-hover" style="margin:5em 0">
			...
			<tbody>
				...
				<tr class="textoPromedio">
					...
					<td>{{ $w->item_precio }} BsF.</td>
					<td>
						<button class="btn btn-primary contArtPrinc" data-id="{{ $w->id }}" data-toggle="modal" data-target="#showItem">Comprar</button>
					</td>
