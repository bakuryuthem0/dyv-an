  ...
  background-color: #286090;
   ...
   <body style="font-family:'Roboto','san serif';padding:2em 4em;">
      ...
      <div>
         ...
         <p class="bg-primary" style="padding:1em;">Este mensaje fue enviado por dyv-an.com debido a su solicitud de {{ $title }} a continuacion se le mostrara su nueva contraña.</p>
          <p class="bg-primary" style="padding:1em;">{{ $pass }}</p>

         <ul>
            <li>Si usted no solicitó recuperar su contraseña en <strong>dyv-an.com</strong>, contáctenos mediante nuestro portal.</li>
