...
.bg-primary:hover {
  background-color: #286090;
   ...
   <body style="font-family:'Roboto','san serif';padding:2em 4em;">
      <img src="http://preview.dyv-an.com/public/images/logo2.png" style="width:40%;">
      <div>
      	<legend>Estimado administrador</legend>
         <ul>
            <li>Este mensaje le fue enviado debido a la creación de un nuevo administrador en <strong>dyv-an.com</strong>. .</li>
         </ul>
         ...
         <ul>
	      ...
	      <p  style="text-align:center;">Atentamente <span class="bg-primary" style="color:white;">dyv-an.com</span></p>
	  </div>
   </body>
</html>